...
///  * [Switch], a widget with semantics similar to [NoteViewCheckbox].
...
class NoteViewCheckbox extends StatefulWidget {
  ...
  ///
  /// NoteViewCheckbox displays a dash when its value is null.
  ///
...
class _CheckboxState extends State<NoteViewCheckbox>
  ...
  @override
  void didUpdateWidget(NoteViewCheckbox oldWidget) {
...
class _CheckboxPainter extends ToggleablePainter {
  ...
  // At t == 0.0, the outer rect's size is _kEdgeSize (NoteViewCheckbox.width)
