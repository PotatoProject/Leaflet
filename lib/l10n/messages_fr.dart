...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "note_emptyTrash" : MessageLookupByLibrary.simpleMessage("Corbeille vide"),
    ...
    "notesMainPageRoute_emptyTrash" : MessageLookupByLibrary.simpleMessage("La corbeille est vide"),
    "notesMainPageRoute_noNotes" : MessageLookupByLibrary.simpleMessage("Aucune note encore ajoutée"),
    "notesMainPageRoute_note_deleteDialog_content" : MessageLookupByLibrary.simpleMessage("Une fois que les notes seront supprimées, vous ne pourrez plus les récupérer.\nÊtes-vous sûr de vouloir continuer ?"),
    "notesMainPageRoute_note_deleteDialog_title" : MessageLookupByLibrary.simpleMessage("Supprimer les notes sélectionnées ?"),
    "notesMainPageRoute_note_emptyTrash_content" : MessageLookupByLibrary.simpleMessage("Une fois que les notes seront supprimées, vous ne pourrez plus les récupérer.\nÊtes-vous sûr de vouloir continuer ?"),
    ...
    "syncLoginRoute_emailOrUsername" : MessageLookupByLibrary.simpleMessage("Adresse email ou nom d\'utilisateur"),
    "syncLoginRoute_emptyField" : MessageLookupByLibrary.simpleMessage("Ce champ ne peut pas être vide !"),
    "syncLoginRoute_login" : MessageLookupByLibrary.simpleMessage("Identifiez-vous"),
    "syncLoginRoute_noteConflictDialog_content" : MessageLookupByLibrary.simpleMessage("Notes enregistrées et messages synchronisés en conflit.\nQue voulez-vous faire ?"),
    "syncLoginRoute_noteConflictDialog_keep" : MessageLookupByLibrary.simpleMessage("Garder à jour et les télécharger"),
    "syncLoginRoute_noteConflictDialog_replace" : MessageLookupByLibrary.simpleMessage("Remplacer ceux qui sont enregistrés par ceux du cloud"),
    "syncLoginRoute_noteConflictDialog_title" : MessageLookupByLibrary.simpleMessage("Notes trouvées sur votre compte"),
    "syncLoginRoute_password" : MessageLookupByLibrary.simpleMessage("Mot de passe"),
    "syncLoginRoute_register" : MessageLookupByLibrary.simpleMessage("Inscrivez-vous"),
    "syncLoginRoute_successfulRegistration" : MessageLookupByLibrary.simpleMessage("Enregistré avec succès"),
    "syncManageRoute_account" : MessageLookupByLibrary.simpleMessage("Compte"),
    "syncManageRoute_account_changeImage" : MessageLookupByLibrary.simpleMessage("Changer d\'image"),
    "syncManageRoute_account_changeUsername" : MessageLookupByLibrary.simpleMessage("Changer de nom d\'utilisateur"),
    "syncManageRoute_account_guest" : MessageLookupByLibrary.simpleMessage("Invité"),
    "syncManageRoute_account_loggedInAs" : m3,
    "syncManageRoute_account_logout" : MessageLookupByLibrary.simpleMessage("Se déconnecter"),
    "syncManageRoute_sync" : MessageLookupByLibrary.simpleMessage("Synchroniser"),
    "syncManageRoute_sync_autoSyncInterval" : MessageLookupByLibrary.simpleMessage("Intervalle de synchronisation automatique (secondes)"),
    "syncManageRoute_sync_enableAutoSync" : MessageLookupByLibrary.simpleMessage("Activer la synchronisation automatique"),
    "syncRegisterRoute_confirmPassword" : MessageLookupByLibrary.simpleMessage("Confirmer le mot de passe"),
    "syncRegisterRoute_confirmPassword_noMatch" : MessageLookupByLibrary.simpleMessage("Le mot de passe ne correspond pas"),
    "syncRegisterRoute_email" : MessageLookupByLibrary.simpleMessage("Adresse email"),
    "syncRegisterRoute_email_empty" : MessageLookupByLibrary.simpleMessage("L\'adresse email ne peut pas être vide"),
    "syncRegisterRoute_email_invalidFormat" : MessageLookupByLibrary.simpleMessage("Format d\'email invalide"),
    "syncRegisterRoute_password" : MessageLookupByLibrary.simpleMessage("Mot de passe"),
    "syncRegisterRoute_password_empty" : MessageLookupByLibrary.simpleMessage("Le champ mot de passe ne peut être vide"),
    "syncRegisterRoute_register" : MessageLookupByLibrary.simpleMessage("Inscrivez-vous"),
    "syncRegisterRoute_username" : MessageLookupByLibrary.simpleMessage("Nom d\'utilisateur"),
    "syncRegisterRoute_username_empty" : MessageLookupByLibrary.simpleMessage("Le champ du nom d\'utilisateur ne peut être vide"),
    "sync_accNotFoundError" : MessageLookupByLibrary.simpleMessage("Le compte n\'a pas été trouvé"),
    "sync_dbConnectionError" : MessageLookupByLibrary.simpleMessage("Il y a eu un problème de connexion à la base de données, réessayez plus tard"),
    "sync_emailAlreadyExistsError" : MessageLookupByLibrary.simpleMessage("L\'e-mail que vous avez saisi semble déjà être enregistré"),
    "sync_invalidCredentialsError" : MessageLookupByLibrary.simpleMessage("Mauvaise combinaison utilisateur/email et mot de passe"),
    "sync_malformedEmailError" : MessageLookupByLibrary.simpleMessage("E-mail mal formé ou manquant"),
    "sync_missingNoteIdError" : MessageLookupByLibrary.simpleMessage("Vous ne pouvez pas créer une note sans un id"),
    "sync_notFoundError" : MessageLookupByLibrary.simpleMessage("Le compte n\'a pas été trouvé"),
    "sync_outOfBoundsError" : MessageLookupByLibrary.simpleMessage("Le texte que vous avez entré est trop long ou trop court"),
    "sync_passOutOfBoundsError" : MessageLookupByLibrary.simpleMessage("Le mot de passe saisi est trop long ou trop court"),
    "sync_userNotFoundError" : MessageLookupByLibrary.simpleMessage("L\'utilisateur n\'a pas été trouvé"),
    "sync_usernameAlreadyExistsError" : MessageLookupByLibrary.simpleMessage("Le nom d\'utilisateur que vous avez saisi semble déjà être enregistré"),
    "sync_usernameNotFoundError" : MessageLookupByLibrary.simpleMessage("Ce nom d\'utilisateur n\'est pas enregistré"),
    "sync_usernameOutOfBoundsError" : MessageLookupByLibrary.simpleMessage("Le nom d\'utilisateur que vous avez saisi est trop long ou trop court"),
    ...
    "welcomeRoute_firstPage_catchPhrase" : MessageLookupByLibrary.simpleMessage("Votre nouvelle application de notes préférée"),
    "welcomeRoute_fourthPage_description" : MessageLookupByLibrary.simpleMessage("Et vous en avez fini avec ça. Maintenant vous pouvez enfin vous amuser ! Ouaiiis !"),
    "welcomeRoute_fourthPage_thankyou" : MessageLookupByLibrary.simpleMessage("Merci d\'avoir choisi PotatoNotes"),
    "welcomeRoute_fourthPage_title" : MessageLookupByLibrary.simpleMessage("Setup terminé"),
    "welcomeRoute_secondPage_title" : MessageLookupByLibrary.simpleMessage("Personnalisation basique"),
    "welcomeRoute_thirdPage_description" : MessageLookupByLibrary.simpleMessage("Avec un compte PotatoSync gratuit, vous pouvez synchroniser vos notes entre plusieurs appareils. Et c\'est super easy d\'en avoir un !"),
    "welcomeRoute_thirdPage_getStarted" : MessageLookupByLibrary.simpleMessage("Commencer"),
    "welcomeRoute_thirdPage_success" : MessageLookupByLibrary.simpleMessage("PotatoSync à été configuré correctement. Bravo !")
  };
}
