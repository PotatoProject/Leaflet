...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static _notInlinedMessages(_) => <String, Function> {
    ...
    "note_emptyTrash" : MessageLookupByLibrary.simpleMessage("Svuota cestino"),
    ...
    "syncLoginRoute_emailOrUsername" : MessageLookupByLibrary.simpleMessage("Email o nome utente"),
    "syncLoginRoute_emptyField" : MessageLookupByLibrary.simpleMessage("Questo spazio non può essere vuoto!"),
    "syncLoginRoute_login" : MessageLookupByLibrary.simpleMessage("Accedi"),
    "syncLoginRoute_noteConflictDialog_content" : MessageLookupByLibrary.simpleMessage("Gli appunti salvati e quelli sul cloud vanno in conflitto.\nCosa si desidare fare?"),
    "syncLoginRoute_noteConflictDialog_keep" : MessageLookupByLibrary.simpleMessage("Mantieni attuali e caricali"),
    "syncLoginRoute_noteConflictDialog_replace" : MessageLookupByLibrary.simpleMessage("Rimpiazza con quelli sul cloud"),
    "syncLoginRoute_noteConflictDialog_title" : MessageLookupByLibrary.simpleMessage("Sono stati trovati appunti sul tuo account"),
    "syncLoginRoute_password" : MessageLookupByLibrary.simpleMessage("Password"),
    "syncLoginRoute_register" : MessageLookupByLibrary.simpleMessage("Registrati"),
    "syncLoginRoute_successfulRegistration" : MessageLookupByLibrary.simpleMessage("Registrato con successo"),
    "syncManageRoute_account" : MessageLookupByLibrary.simpleMessage("Account"),
    "syncManageRoute_account_changeImage" : MessageLookupByLibrary.simpleMessage("Cambia immagine"),
    "syncManageRoute_account_changeUsername" : MessageLookupByLibrary.simpleMessage("Cambia username"),
    "syncManageRoute_account_guest" : MessageLookupByLibrary.simpleMessage("Ospite"),
    "syncManageRoute_account_loggedInAs" : m3,
    "syncManageRoute_account_logout" : MessageLookupByLibrary.simpleMessage("Esci"),
    "syncManageRoute_sync" : MessageLookupByLibrary.simpleMessage("Sincronizzazione"),
    "syncManageRoute_sync_autoSyncInterval" : MessageLookupByLibrary.simpleMessage("Intervallo di tempo in secondi per la sincronizzazione automatica"),
    "syncManageRoute_sync_enableAutoSync" : MessageLookupByLibrary.simpleMessage("Attiva la sincronizzazione automatica"),
    "syncRegisterRoute_confirmPassword" : MessageLookupByLibrary.simpleMessage("Conferma password"),
    "syncRegisterRoute_confirmPassword_noMatch" : MessageLookupByLibrary.simpleMessage("Le password non corrispondono"),
    "syncRegisterRoute_email" : MessageLookupByLibrary.simpleMessage("Email"),
    "syncRegisterRoute_email_empty" : MessageLookupByLibrary.simpleMessage("L\'email non può essere vuota"),
    "syncRegisterRoute_email_invalidFormat" : MessageLookupByLibrary.simpleMessage("Formato dell\'email non valido"),
    "syncRegisterRoute_password" : MessageLookupByLibrary.simpleMessage("Password"),
    "syncRegisterRoute_password_empty" : MessageLookupByLibrary.simpleMessage("La password non può essere vuota"),
    "syncRegisterRoute_register" : MessageLookupByLibrary.simpleMessage("Registrazione"),
    "syncRegisterRoute_username" : MessageLookupByLibrary.simpleMessage("Nome utente"),
    "syncRegisterRoute_username_empty" : MessageLookupByLibrary.simpleMessage("Il nome utente non può essere vuoto"),
    "sync_accNotFoundError" : MessageLookupByLibrary.simpleMessage("Account non trovato"),
    "sync_dbConnectionError" : MessageLookupByLibrary.simpleMessage("Si è verificato un errore nel connettersi al database, riprova più tardi"),
    "sync_emailAlreadyExistsError" : MessageLookupByLibrary.simpleMessage("L\'email inserita sembra essere già registrata"),
    "sync_invalidCredentialsError" : MessageLookupByLibrary.simpleMessage("Combinazione nome utente/email e password non valida"),
    "sync_malformedEmailError" : MessageLookupByLibrary.simpleMessage("Email non valida o inesistente"),
    "sync_missingNoteIdError" : MessageLookupByLibrary.simpleMessage("Non puoi creare un appunto senza id"),
    "sync_notFoundError" : MessageLookupByLibrary.simpleMessage("L\'account non è stato trovato"),
    "sync_outOfBoundsError" : MessageLookupByLibrary.simpleMessage("La stringa inserita è troppo lunga o troppo corta"),
    "sync_passOutOfBoundsError" : MessageLookupByLibrary.simpleMessage("La password inserita è troppo lunga o troppo corta"),
    "sync_userNotFoundError" : MessageLookupByLibrary.simpleMessage("Utente non trovato"),
    "sync_usernameAlreadyExistsError" : MessageLookupByLibrary.simpleMessage("Il nome utente inserito sembra essere già registrato"),
    "sync_usernameNotFoundError" : MessageLookupByLibrary.simpleMessage("Nome utente non registrato"),
    "sync_usernameOutOfBoundsError" : MessageLookupByLibrary.simpleMessage("Il nome utente inserito è troppo lungo o troppo corto"),
    ...
    "welcomeRoute_firstPage_catchPhrase" : MessageLookupByLibrary.simpleMessage("La tua nuova app per gli appunti preferita"),
    "welcomeRoute_fourthPage_description" : MessageLookupByLibrary.simpleMessage("E con questo hai finito. Finalmente ti puoi divertire! Evviva!"),
    "welcomeRoute_fourthPage_thankyou" : MessageLookupByLibrary.simpleMessage("Grazie per aver scelto PotatoNotes"),
    "welcomeRoute_fourthPage_title" : MessageLookupByLibrary.simpleMessage("Setup completato"),
    "welcomeRoute_secondPage_title" : MessageLookupByLibrary.simpleMessage("Personalizzazione di base"),
    "welcomeRoute_thirdPage_description" : MessageLookupByLibrary.simpleMessage("Con un account gratuito PotatoSync, puoi sincronizzare i tuoi appunti tra dispositivi vari. Ed è super semplice ottenerne uno!"),
    "welcomeRoute_thirdPage_getStarted" : MessageLookupByLibrary.simpleMessage("Iniziamo"),
    "welcomeRoute_thirdPage_success" : MessageLookupByLibrary.simpleMessage("Hai configurato PotatoSync con successo. Ben fatto!")
  };
}
