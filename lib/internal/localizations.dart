...
class AppLocalizations {
  ...
  String get chooseAction => Intl.message("Choose action", name: "chooseAction");
  ...
  String get notesMainPageRoute_addButtonTooltip => Intl.message(
    "Add new note",
    name: "notesMainPageRoute_addButtonTooltip",
    desc: "Tooltip that is shown when long pressing the FAB",
  );
  ...
  String modifyNotesRoute_security_dialog_lengthExceed(String method, String maxLength) => Intl.message(
    "$method length can't exceed $maxLength",
    name: "modifyNotesRoute_security_dialog_lengthExceed",
    args: [method, maxLength],
  );

  String modifyNotesRoute_security_dialog_lengthShort(String method, String minLength) => Intl.message(
  ...
  String get modifyNotesRoute_color_change => Intl.message(
    ...
    desc: "Used in the three dots menu on modify notes route, for modifying note color",
  );
  ...
  String settingsRoute_backupAndRestore_backup_done(String path) => Intl.message(
  ...
  String get note_exportLocation => Intl.message(
    ...
    desc: "Used on the snackbar that appears when exporting a note, followed by the note path",
  );
