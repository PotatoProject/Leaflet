...
class ImageQueue {
  ...
  static Future<bool> hasDuplicates(SavedImage data, {NoteHelper? noteHelper}) async{
    if(noteHelper == null)
      noteHelper = helper;
  ...
  static Future<void> uploadItem(UploadQueueItem item, String tempDirectory) async{
