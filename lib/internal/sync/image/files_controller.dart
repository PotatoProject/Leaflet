...
class FilesController {
  ...
  static Future<void> deleteImage(String hash) async {
    ...
    Response deleteResult = await http.delete(url, headers: {
      "Authorization": "Bearer $token"});
    Loggy.d(message: "($hash deleteImage) Server responded with (${deleteResult.statusCode}): ${deleteResult.body}");
